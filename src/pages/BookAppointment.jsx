...
const scheduledAt = new Date(`${selectedDate} ${selectedSlot}`).toISOString(); // ✅ ISO format

    // const scheduledAt = new Date(`${selectedDate} ${selectedSlot}`);
    const payload = {
      userId: user._id,
      doctorId: doctor._id,
      scheduledAt,
      ...
      <div className="appointment-content">
        ...
        <div className="doctor-profile">
          ...
          <div className="fee-box">
            <span className="fee-label">₹</span> {doctor?.consultationFee} consultation
          </div>
